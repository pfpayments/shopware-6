...
export const CONFIG_KEEP_FAILED_PAYMENTS_ORDER_OPEN = CONFIG_DOMAIN + '.' + 'keepFailedPaymentsOrderOpen';
export const CONFIG_PRODUCT_CUSTOM_FIELDS_ALLOW_LIST = CONFIG_DOMAIN + '.' + 'productCustomFieldsAllowList';
...
export default {
    ...
    CONFIG_KEEP_FAILED_PAYMENTS_ORDER_OPEN,
    CONFIG_PRODUCT_CUSTOM_FIELDS_ALLOW_LIST,
