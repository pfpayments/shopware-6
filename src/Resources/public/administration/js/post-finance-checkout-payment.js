...
{% endblock %}
`;var{Component:oe,Context:y}=Shopware,se=Shopware.Data.Criteria,re="handler_postfinancecheckoutpayment_postfinancecheckoutpaymenthandler";oe.override("sw-order-detail",{template:I,data(){return{isPostFinanceCheckoutPayment:!1}},computed:{isEditable(){return!this.isPostFinanceCheckoutPayment||this.$route.name!=="postfinancecheckout.order.detail"},showTabs(){return!0}},watch:{orderId:{deep:!0,handler(){if(!this.orderId){this.setIsPostFinanceCheckoutPayment(null);return}let e=this.repositoryFactory.create("order"),t=new se(1,1);t.addAssociation("transactions"),e.get(this.orderId,y.api,t).then(n=>{if(n.amountTotal<=0||n.transactions.length<=0||!n.transactions[0].paymentMethodId){this.setIsPostFinanceCheckoutPayment(null);return}let a=n.transactions[0].paymentMethodId;a!=null&&this.setIsPostFinanceCheckoutPayment(a)})},immediate:!0}},methods:{setIsPostFinanceCheckoutPayment(e){if(!e)return;this.repositoryFactory.create("payment_method").get(e,y.api).then(n=>{this.isPostFinanceCheckoutPayment=n.formattedHandlerIdentifier===re})}}});var E=`{% block postfinancecheckout_order_action_completion %}
...
{% endblock %}
`;var{Component:le,Mixin:de,Filter:ue,Utils:S}=Shopware;le.register("postfinancecheckout-order-action-completion",{template:E,inject:["PostFinanceCheckoutTransactionCompletionService"],mixins:[de.getByName("notification")],props:{transactionData:{type:Object,required:!0}},data(){return{isLoading:!0,isCompletion:!1}},computed:{dateFilter(){return ue.getByName("date")}},created(){this.createdComponent()},methods:{createdComponent(){this.isLoading=!1},completion(){this.isCompletion&&(this.isLoading=!0,this.PostFinanceCheckoutTransactionCompletionService.createTransactionCompletion(this.transactionData.transactions[0].metaData.salesChannelId,this.transactionData.transactions[0].id).then(()=>{this.createNotificationSuccess({title:this.$tc("postfinancecheckout-order.captureAction.successTitle"),message:this.$tc("postfinancecheckout-order.captureAction.successMessage")}),this.isLoading=!1,this.$emit("modal-close"),this.$nextTick(()=>{this.$router.replace(`${this.$route.path}?hash=${S.createId()}`)})}).catch(e=>{try{this.createNotificationError({title:e.response.data.errors[0].title,message:e.response.data.errors[0].detail,autoClose:!1})}catch{this.createNotificationError({title:e.title,message:e.message,autoClose:!1})}finally{this.isLoading=!1,this.$emit("modal-close"),this.$nextTick(()=>{this.$router.replace(`${this.$route.path}?hash=${S.createId()}`)})}}))}}});var F=`{% block postfinancecheckout_order_action_refund %}
<sw-modal variant="small"
...
{% endblock %}
`;var{Component:he,Mixin:me,Filter:fe,Utils:v}=Shopware;he.register("postfinancecheckout-order-action-refund",{template:F,inject:["PostFinanceCheckoutRefundService"],mixins:[me.getByName("notification")],props:{transactionData:{type:Object,required:!0},orderId:{type:String,required:!0}},data(){return{refundQuantity:0,isLoading:!0,currentLineItem:""}},computed:{dateFilter(){return fe.getByName("date")}},created(){this.createdComponent()},methods:{createdComponent(){this.isLoading=!1,this.refundQuantity=1},refund(){this.isLoading=!0,this.PostFinanceCheckoutRefundService.createRefund(this.transactionData.transactions[0].metaData.salesChannelId,this.transactionData.transactions[0].id,this.refundQuantity,this.$parent.$parent.currentLineItem).then(()=>{this.createNotificationSuccess({title:this.$tc("postfinancecheckout-order.refundAction.successTitle"),message:this.$tc("postfinancecheckout-order.refundAction.successMessage")}),this.isLoading=!1,this.$emit("modal-close"),this.$nextTick(()=>{this.$router.replace(`${this.$route.path}?hash=${v.createId()}`)})}).catch(e=>{try{var t=e?.response?.data?.errors?.[0]?.title??this.$tc("postfinancecheckout-order.refundAction.refundCreateError.errorTitle"),n;switch(e.response.data){case"refundQuantityZero":n=this.$tc("postfinancecheckout-order.refundAction.refundCreateError.messageRefundQuantityIsZero");break;case"refundExceedsQuantity":n=this.$tc("postfinancecheckout-order.refundAction.refundCreateError.messageRefundQuantityExceedsAvailableBalance");break;case"methodDoesNotSupportRefund":n=this.$tc("postfinancecheckout-order.refundAction.refundCreateError.messagePaymentMethodDoesNotSupportRefund");break;default:n=e.response.data.errors[0].detail}this.createNotificationError({title:t,message:n,autoClose:!1})}catch{this.createNotificationError({title:e.title,message:e.message,autoClose:!1})}finally{this.isLoading=!1,this.$emit("modal-close"),this.$nextTick(()=>{this.$router.replace(`${this.$route.path}?hash=${v.createId()}`)})}})}}});var w=`{% block postfinancecheckout_order_action_refund_partial %}
<sw-modal variant="small"
		  :title="$tc(\`postfinancecheckout-order.modal.title.refund\`)"
		  @modal-close="$emit('modal-close')">
...
{% endblock %}
`;var{Component:be,Mixin:_e,Filter:ke,Utils:A}=Shopware;be.register("postfinancecheckout-order-action-refund-partial",{template:w,inject:["PostFinanceCheckoutRefundService"],mixins:[_e.getByName("notification")],props:{transactionData:{type:Object,required:!0},orderId:{type:String,required:!0}},data(){return{isLoading:!0,currency:this.transactionData.transactions[0].currency,refundAmount:0}},computed:{dateFilter(){return ke.getByName("date")}},created(){this.createdComponent()},methods:{createdComponent(){this.isLoading=!1,this.currency=this.transactionData.transactions[0].currency,this.refundAmount||(this.refundAmount=this.$parent.$parent.itemRefundableAmount)},createPartialRefund(e){this.isLoading=!0,this.PostFinanceCheckoutRefundService.createPartialRefund(this.transactionData.transactions[0].metaData.salesChannelId,this.transactionData.transactions[0].id,this.refundAmount,e).then(()=>{this.createNotificationSuccess({title:this.$tc("postfinancecheckout-order.refundAction.successTitle"),message:this.$tc("postfinancecheckout-order.refundAction.successMessage")}),this.isLoading=!1,this.$emit("modal-close"),this.$nextTick(()=>{this.$router.replace(`${this.$route.path}?hash=${A.createId()}`)})}).catch(t=>{try{var n=t?.response?.data?.errors?.[0]?.title??this.$tc("postfinancecheckout-order.refundAction.refundCreateError.errorTitle"),a;t.response.data==="methodDoesNotSupportRefund"?a=this.$tc("postfinancecheckout-order.refundAction.refundCreateError.messagePaymentMethodDoesNotSupportRefund"):a=t.response.data.errors[0].detail,this.createNotificationError({title:n,message:a,autoClose:!1})}catch{this.createNotificationError({title:t.title,message:t.message,autoClose:!1})}finally{this.isLoading=!1,this.$emit("modal-close"),this.$nextTick(()=>{this.$router.replace(`${this.$route.path}?hash=${A.createId()}`)})}})}},watch:{refundAmount(e){e!==null&&(this.refundAmount=Math.round(e*100)/100)}}});var P=`{% block postfinancecheckout_order_action_refund_by_amount %}
<sw-modal variant="small"
		  :title="$tc(\`postfinancecheckout-order.modal.title.refund\`)"
		  @modal-close="$emit('modal-close')">
...
{% endblock %}
`;var{Component:et,Mixin:tt}=Shopware;et.register("sw-postfinancecheckout-credentials",{template:z,name:"PostFinanceCheckoutCredentials",inject:["acl"],mixins:[tt.getByName("notification")],props:{actualConfigData:{type:Object,required:!0},allConfigs:{type:Object,required:!0},selectedSalesChannelId:{type:[String,null],required:!1,default:null},spaceIdFilled:{type:Boolean,required:!0},spaceIdErrorState:{required:!0},userIdFilled:{type:Boolean,required:!0},userIdErrorState:{required:!0},applicationKeyFilled:{type:Boolean,required:!0},applicationKeyErrorState:{required:!0},isLoading:{type:Boolean,required:!0},isTesting:{type:Boolean,required:!1}},data(){return{...c}},computed:{currentConfig(){return this.selectedSalesChannelId&&this.allConfigs[this.selectedSalesChannelId]?this.allConfigs[this.selectedSalesChannelId]:this.allConfigs.null||{}}},methods:{checkTextFieldInheritance(e){return!e||e.length<=0},checkNumberFieldInheritance(e){return e==null||e===""},checkBoolFieldInheritance(e){return typeof e!="boolean"},emitCheckApiConnectionEvent(){let e={spaceId:this.currentConfig[c.CONFIG_SPACE_ID],userId:this.currentConfig[c.CONFIG_USER_ID],applicationKey:this.currentConfig[c.CONFIG_APPLICATION_KEY]};this.$emit("check-api-connection-event",e)},getInheritedValue(e){return this.allConfigs.null?.[e]??null}}});var q=`{% block postfinancecheckout_settings_content_card_channel_config_options %}
			...
			<sw-container>
				...
				{% block postfinancecheckout_settings_content_card_channel_config_credentials_card_container_settings %}
					<div v-if="actualConfigData" class="postfinancecheckout-settings-options-fields">
						...
						{% block postfinancecheckout_settings_content_card_channel_config_credentials_card_container_settings_product_custom_fields_allow_list %}
							<sw-inherit-wrapper
									v-model:value="actualConfigData[CONFIG_PRODUCT_CUSTOM_FIELDS_ALLOW_LIST]"
									:inheritedValue="selectedSalesChannelId == null ? null : allConfigs['null'][CONFIG_PRODUCT_CUSTOM_FIELDS_ALLOW_LIST]"
									:customInheritationCheckFunction="checkMultiSelectFieldInheritance">
								<template #content="props">
									<sw-multi-select
											:name="CONFIG_PRODUCT_CUSTOM_FIELDS_ALLOW_LIST"
											labelProperty="label"
											valueProperty="value"
											:options="productCustomFieldOptions"
											:mapInheritance="props"
											:label="$tc('postfinancecheckout-settings.settingForm.options.productCustomFieldsAllowList.label')"
											:helpText="$tc('postfinancecheckout-settings.settingForm.options.productCustomFieldsAllowList.tooltipText')"
											:disabled="props.isInherited"
											:value="props.currentValue || []"
											@update:value="props.updateCurrentValue">
									</sw-multi-select>
...
{% endblock %}
`;var{Component:at,Mixin:it,Context:ot}=Shopware,f=Shopware.Data.Criteria;at.register("sw-postfinancecheckout-options",{template:q,name:"PostFinanceCheckoutOptions",inject:["repositoryFactory"],mixins:[it.getByName("notification")],props:{actualConfigData:{type:Object,required:!0},allConfigs:{type:Object,required:!0},selectedSalesChannelId:{required:!0},isLoading:{type:Boolean,required:!0}},data(){return{...c,productCustomFields:[]}},created(){this.loadProductCustomFields()},computed:{customFieldRepository(){return this.repositoryFactory.create("custom_field")},productCustomFieldOptions(){let e=Shopware.Store&&Shopware.Store.get?Shopware.Store.get("session"):null,t=e&&e.currentLocale||"en-GB";return this.productCustomFields.map(n=>{let a=n.config&&n.config.label?n.config.label[t]||n.config.label["en-GB"]:null;return{value:n.name,label:a&&a!==n.name?`${a} (${n.name})`:n.name}})},integrationOptions(){return[{id:"payment_page",name:this.$tc("postfinancecheckout-settings.settingForm.options.integration.options.payment_page")},{id:"iframe",name:this.$tc("postfinancecheckout-settings.settingForm.options.integration.options.iframe")}]}},methods:{loadProductCustomFields(){let e=new f(1,500);e.addFilter(f.equals("customFieldSet.relations.entityName","product")),e.addSorting(f.sort("name","ASC")),this.customFieldRepository.search(e,ot.api).then(t=>{this.productCustomFields=t})},checkMultiSelectFieldInheritance(e){return!Array.isArray(e)||e.length<=0},checkTextFieldInheritance(e){return typeof e!="string"?!0:e.length<=0},checkNumberFieldInheritance(e){return typeof e!="number"?!0:e.length<=0},checkBoolFieldInheritance(e){return typeof e!="boolean"}}});var V=`{% block postfinancecheckout_settings_icon %}
...
{% endblock %}
`;var{Component:rt}=Shopware;rt.register("sw-postfinancecheckout-settings-icon",{template:V});var U=`<mt-card class="mt-card"
...
`;var{Component:lt,Mixin:dt}=Shopware;lt.register("sw-postfinancecheckout-storefront-options",{template:U,name:"PostFinanceCheckoutStorefrontOptions",mixins:[dt.getByName("notification")],props:{actualConfigData:{type:Object,required:!0},allConfigs:{type:Object,required:!0},selectedSalesChannelId:{required:!0},isLoading:{type:Boolean,required:!0}},data(){return{...c}},methods:{checkTextFieldInheritance(e){return typeof e!="string"?!0:e.length<=0},checkNumberFieldInheritance(e){return typeof e!="number"?!0:e.length<=0},checkBoolFieldInheritance(e){return typeof e!="boolean"}}});var H=`<mt-card class="mt-card"
